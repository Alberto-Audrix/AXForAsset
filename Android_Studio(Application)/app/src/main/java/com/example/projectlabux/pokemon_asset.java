...
public class pokemon_asset extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pokemon_asset);
        buy = findViewById(R.id.buyBtn);
        back = findViewById(R.id.backBtn);
        email = findViewById(R.id.email);
        buttonListener();
        autoCompleteTextView = findViewById(R.id.autoText4);
    ...
    public void alertMailEmpty(){
        AlertDialog.Builder error = new AlertDialog.Builder(pokemon_asset.this);
    ...
    void buttonListener(){
        back.setOnClickListener(e->{
            Intent intent = new Intent(pokemon_asset.this,home_page.class);
            pokemon_asset.this.startActivity(intent);
        });
        buy.setOnClickListener(e->{
            ...
            if(mail.isEmpty()){
                ...
                confirmSuccess();
                Intent intent = new Intent(pokemon_asset.this,items_page.class);
                pokemon_asset.this.startActivity(intent);
            }
        });
    }
