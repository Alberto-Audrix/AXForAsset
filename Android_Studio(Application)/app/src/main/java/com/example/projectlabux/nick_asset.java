...
public class nick_asset extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nick_asset);
        buy = findViewById(R.id.buyBtn);
        back = findViewById(R.id.backBtn);
        email = findViewById(R.id.email);
        buttonListener();
        autoCompleteTextView = findViewById(R.id.autoText2);
    ...
    public void alertMailEmpty(){
        AlertDialog.Builder error = new AlertDialog.Builder(nick_asset.this);
    ...
    void buttonListener(){
        back.setOnClickListener(e->{
            Intent intent = new Intent(nick_asset.this,home_page.class);
            nick_asset.this.startActivity(intent);
        });
        buy.setOnClickListener(e->{
            ...
            if(mail.isEmpty()){
                ...
                confirmSuccess();
                Intent intent = new Intent(nick_asset.this,items_page.class);
                nick_asset.this.startActivity(intent);
            }
        });
    }
