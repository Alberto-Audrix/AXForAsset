...
public class mhs2_asset extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mhs2_asset);
        buy = findViewById(R.id.buyBtn);
        back = findViewById(R.id.backBtn);
        email = findViewById(R.id.email);
        buttonListener();
        autoCompleteTextView = findViewById(R.id.autoText3);
    ...
    public void alertMailEmpty(){
        AlertDialog.Builder error = new AlertDialog.Builder(mhs2_asset.this);
    ...
    void buttonListener(){
        back.setOnClickListener(e->{
            Intent intent = new Intent(mhs2_asset.this,home_page.class);
            mhs2_asset.this.startActivity(intent);
        });
        buy.setOnClickListener(e->{
            ...
            if(mail.isEmpty()){
                ...
                confirmSuccess();
                Intent intent = new Intent(mhs2_asset.this,items_page.class);
                mhs2_asset.this.startActivity(intent);
            }
        });
    }
