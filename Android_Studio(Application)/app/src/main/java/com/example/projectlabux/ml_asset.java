...
public class ml_asset extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ml_asset);
        buy = findViewById(R.id.buyBtn);
        back = findViewById(R.id.backBtn);
        email = findViewById(R.id.email);
        buttonListener();
        autoCompleteTextView = findViewById(R.id.autoText5);
    ...
    public void alertMailEmpty(){
        AlertDialog.Builder error = new AlertDialog.Builder(ml_asset.this);
    ...
    void buttonListener(){
        back.setOnClickListener(e->{
            Intent intent = new Intent(ml_asset.this,home_page.class);
            ml_asset.this.startActivity(intent);
        });
        buy.setOnClickListener(e->{
            ...
            if(mail.isEmpty()){
                ...
                confirmSuccess();
                Intent intent = new Intent(ml_asset.this,items_page.class);
                ml_asset.this.startActivity(intent);
            }
        });
    }
